...
public class UserApplicationRequest
{
    ...
    [StringLength(100, ErrorMessage = "Country cannot be longer than 50 characters.")]
    ...
    /// </summary>
    [StringLength(100, ErrorMessage = "Referral information cannot be longer than 250 characters.")]
